          ...
          <div className="row row-size">
            ...
            <div className="col-md-4 ml-5">
              ...
              <p>
                ...
                Aren't it fun and frustrated at the same time? Yes, and that's
        ...
        <div className="about-background">
          <div className="row row-size-medium">
            <div className="col-md-1 pt-3 pl-4">
              ...
              />
              <img src={blurPhoto} alt="myPhoto" className="img-blur-medium" />
            </div>
            <div className="col-md-2">
              <img src={bcPhoto} alt="myPhoto" className="img-self-medium" />
            </div>
            <div className="col-md-3" />
